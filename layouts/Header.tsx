...
const Header = () => {
  return (
    <header className='fixed flex items-center min-h-[60px] z-40 shadow-md  shadow-indigo-500/40 dark:shadow-dark  py-1  left-0 right-0 w-full bg-indigo-600 dark:bg-darker'>
